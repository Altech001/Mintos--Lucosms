...
export interface ItemsApiInterface {
     ...
     */
    itemsCreateItemRaw(requestParameters: ItemsCreateItemRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ItemPublic>>;

    /**
     * Create new item.
     * Create Item
     */
    itemsCreateItem(requestParameters: ItemsCreateItemRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ItemPublic>;
     ...
     * @memberof ItemsApiInterface
     */
    itemsDeleteItemRaw(requestParameters: ItemsDeleteItemRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Message>>;

    /**
     * Delete an item.
     * Delete Item
     */
    itemsDeleteItem(requestParameters: ItemsDeleteItemRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Message>;
     ...
     * @memberof ItemsApiInterface
     */
    itemsReadItemRaw(requestParameters: ItemsReadItemRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ItemPublic>>;

    /**
     * Get item by ID.
     * Read Item
     */
    itemsReadItem(requestParameters: ItemsReadItemRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ItemPublic>;
     ...
     * @memberof ItemsApiInterface
     */
    itemsReadItemsRaw(requestParameters: ItemsReadItemsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ItemsPublic>>;

    /**
     * Retrieve items.
     * Read Items
     */
    itemsReadItems(requestParameters: ItemsReadItemsRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ItemsPublic>;
     ...
     * @memberof ItemsApiInterface
     */
    itemsUpdateItemRaw(requestParameters: ItemsUpdateItemRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<ItemPublic>>;

    /**
     * Update an item.
     * Update Item
     */
    itemsUpdateItem(requestParameters: ItemsUpdateItemRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<ItemPublic>;
