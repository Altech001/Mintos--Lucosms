...
export interface UtilsApiInterface {
     ...
     */
    utilsHealthCheckRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<boolean>>;

    /**
     * Health Check
     */
    utilsHealthCheck(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<boolean>;
     ...
     * @memberof UtilsApiInterface
     */
    utilsTestEmailRaw(requestParameters: UtilsTestEmailRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Message>>;

    /**
     * Test emails.
     * Test Email
     */
    utilsTestEmail(requestParameters: UtilsTestEmailRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<Message>;
...
export class UtilsApi extends runtime.BaseAPI implements UtilsApiInterface {
    ...
    async utilsHealthCheckRaw(initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<boolean>> {
        ...
        let urlPath = `/api/v1/utils/health-check/`;
    ...
    async utilsTestEmailRaw(requestParameters: UtilsTestEmailRequest, initOverrides?: RequestInit | runtime.InitOverrideFunction): Promise<runtime.ApiResponse<Message>> {
        ...
        let urlPath = `/api/v1/utils/test-email/`;
